...
export class SubtitleToken__subtitleNFTResult {
  value0: Address;
  value1: BigInt;
  value2: i32;
  value3: BigInt;
...
export class SubtitleToken extends ethereum.SmartContract {
  ...
  subtitleNFT(param0: BigInt): SubtitleToken__subtitleNFTResult {
    let result = super.call(
      "subtitleNFT",
      "subtitleNFT(uint256):(address,uint256,uint16,uint256)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    );

    return new SubtitleToken__subtitleNFTResult(
      result[0].toAddress(),
      result[1].toBigInt(),
      result[2].toI32(),
      result[3].toBigInt()
  ...
  try_subtitleNFT(
    param0: BigInt
  ): ethereum.CallResult<SubtitleToken__subtitleNFTResult> {
    let result = super.tryCall(
      "subtitleNFT",
      "subtitleNFT(uint256):(address,uint256,uint16,uint256)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    return ethereum.CallResult.fromValue(
      new SubtitleToken__subtitleNFTResult(
        value[0].toAddress(),
        value[1].toBigInt(),
        value[2].toI32(),
        value[3].toBigInt()
  ...
  subtitleSystem(): Address {
    let result = super.call("subtitleSystem", "subtitleSystem():(address)", []);

    return result[0].toAddress();
  }

  try_subtitleSystem(): ethereum.CallResult<Address> {
    let result = super.tryCall(
      "subtitleSystem",
      "subtitleSystem():(address)",
      []
